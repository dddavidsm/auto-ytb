...
const scenes=planScenes(script); assert.ok(scenes.length>=3); assert.ok(scenes.some(s=>s.generated)); assert.ok(estimateProductionCost({narrationSeconds:100,scenes})>0);
...
const manifest={projectId:'x',createdAt:'x',script,packaging:[packaging],selectedPackagingId:'p',scenes,assets:[],estimatedCostUsd:1,actualCostUsd:0,containsSyntheticMedia:true};
