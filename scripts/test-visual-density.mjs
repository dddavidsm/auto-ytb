...
const scenes=planScenes({title:'density',language:'en',targetDurationSec:60,thesis:'test',outro:'',beats},{targetSceneDurationSec:4.5,visualMode:'EVIDENCE_FIRST',generativeSpendBias:0.65});
...
assert.ok(scenes.length>=12,`Shorts need a dense shot plan, got ${scenes.length}`);
assert.ok(generated.length>=7,`Anchor beats should receive multiple specific visuals, got ${generated.length}`);
