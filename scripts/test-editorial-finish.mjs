...
const manifest={
  ...
  script:{title:'Test',language:'en',targetDurationSec:2,thesis:'test',outro:'',beats:[{id:'b1',startSec:0,targetDurationSec:2,purpose:'hook',narration:'A visible caption proves the finishing pass.',onScreenText:'A visible caption',visualIntent:'A simple visual hook',sourceIds:[],retentionDevice:'open_loop'}]},
  scenes:[{id:'b1-s1',startSec:0,durationSec:2,kind:'motion_graphic',instruction:'Simple hook',sourceIds:[],generated:false}],
  ...
  editPlan:{preset:'DOCUMENTARY',transitionMode:'HARD_CUT',transitionDurationSeconds:0,punchInAnchors:true,punchInScale:1.02,filmLook:false,filmGrain:0},
};
