...
const scripts=['scripts/schedule-branding.mjs','scripts/schedule-intelligence.mjs','scripts/series-memory-sync.mjs','scripts/series-kids-quality-sync.mjs','scripts/series-visual-continuity-sync.mjs','scripts/series-performance-sync.mjs','scripts/recheck-series-publication.mjs','scripts/series-episode-planner.mjs','scripts/schedule-production-series.mjs','scripts/schedule-maintenance.mjs'];
async function tick(){
