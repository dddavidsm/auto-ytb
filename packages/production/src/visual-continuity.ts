export type ProductionVisualMode = 'FOOTAGE_PRO' | 'HYBRID_EDITORIAL' | 'GENERATIVE_EDITORIAL' | 'FULL_GENERATIVE' | 'CHARACTER_SERIES' | 'GRAPHIC_EXPLAINER' | 'GENERATIVE_IP' | 'ARCHIVAL';
