...
const checks: Check[] = [
  ...
  check('Generative image', [], ['IMAGE_PROVIDER','IMAGE_API_KEY'], 'Optional: scene planner can prefer sourced/motion assets'),
  check('Generative video', [], ['VIDEO_PROVIDER','VIDEO_API_KEY'], 'Optional and intentionally cost-limited'),
  check('Storage', ['OBJECT_STORE','OBJECT_STORE_BUCKET'], ['OBJECT_STORE_ENDPOINT'], 'Required for distributed rendering/workers'),
