/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 3f1ac0a2d3a777dc56b7df2629d2d09a)
// Runtime types generated with workerd@1.20260923.1 2026-09-24
interface __BaseEnv_Env {
	AUTOYTB_MEDIA: R2Bucket;
	REAL_GENERATION_ENABLED: "false";
	AUTO_UPLOAD_PRIVATE: "false";
	AUTO_YTB_RUNTIME_REVISION: "2026-09-25T00:00:00Z";
	...
	VOICE_ALIGNMENT_STRICT: "true";
	VOICE_ALIGNMENT_MIN_COVERAGE: "0.88";
	...
	LOCAL_RENDER_ROOT: ".data/renders";
	LOCAL_THUMBNAIL_ROOT: ".data/thumbnails";
	LOCAL_BRAND_ROOT: ".data/brand";
	...
	PRIMARY_CHANNEL_KEY: "future-tech-business-en";
	AUTO_CHANNEL_DISCOVERY_ENABLED: "true";
	AUTO_NEW_CHANNEL_MIN_SCORE: "90";
	SERIES_VISUAL_CONTINUITY_ENABLED: "true";
	SERIES_VISUAL_CONTINUITY_MAX_ASSETS: "3";
	SERIES_VISUAL_MIN_OVERALL: "80";
	SERIES_VISUAL_MIN_CHARACTER: "84";
	SERIES_VISUAL_MIN_STYLE: "78";
	MARKET_CYCLE_INTERVAL_HOURS: "6";
	MARKET_JOB_PRIORITY: "70";
	MARKET_MAX_QUERIES: "5";
	MARKET_LOOKBACK_DAYS: "7";
	MARKET_CYCLE_MAX_QUERIES: "5";
	MARKET_CYCLE_RECENT_DAYS: "7";
	MARKET_CYCLE_RESULTS_PER_QUERY: "35";
	MARKET_PATTERN_LOOKBACK_DAYS: "14";
	...
	AUTO_SHORT_RESERVED_COST_USD: "6";
	LEARNING_WINDOW_DAYS: "120";
	ALLOW_COST_EXPERIMENTS: "true";
	ANALYTICS_SYNC_DAYS: "28";
	ANALYTICS_JOB_PRIORITY: "35";
	SHORT_TO_LONG_MIN_VIEWS: "5000";
	SHORT_TO_LONG_MIN_AVP: "70";
	LONG_TO_SHORT_MIN_VIEWS: "3000";
	LONG_TO_SHORT_MIN_AVP: "50";
	JOB_MAX_ATTEMPTS: "4";
	JOB_POLL_MS: "5000";
	JOB_STALE_MINUTES: "120";
	JOB_TIMEOUT_MINUTES: "120";
	JOB_RETRY_BASE_MS: "60000";
	JOB_RETRY_MAX_MS: "21600000";
	AUTOYTB_WEB: DurableObjectNamespace<import("./cloudflare/index").AutoYtbProductionWebContainer>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./cloudflare/index");
		durableNamespaces: "AutoYtbProductionWebContainer";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "REAL_GENERATION_ENABLED" | "AUTO_UPLOAD_PRIVATE" | "AUTO_YTB_RUNTIME_REVISION" | "RUN_BACKGROUND_WORKERS" | "SCHEDULER_INTERVAL_MS" | "SCHEDULER_RUN_IMMEDIATELY" | "GEMINI_API_BASE_URL" | "SEARCH_PROVIDER" | "GEMINI_SEARCH_MODEL" | "TEXT_MODEL_PROVIDER" | "TEXT_MODEL_RESEARCH" | "TEXT_MODEL_CREATIVE" | "TEXT_MODEL_VISION" | "GEMINI_TEXT_MODEL" | "VOICE_PROVIDER" | "VOICE_ID" | "GEMINI_VOICE_ID" | "VOICE_MODEL" | "VOICE_TIMESTAMPS" | "GEMINI_TRANSCRIBE_MODEL" | "VOICE_ALIGNMENT_STRICT" | "VOICE_ALIGNMENT_MIN_COVERAGE" | "IMAGE_PROVIDER" | "IMAGE_MODEL" | "GEMINI_IMAGE_SIZE" | "VIDEO_PROVIDER" | "VIDEO_MODEL" | "GEMINI_VIDEO_RESOLUTION" | "OBJECT_STORE" | "RENDERER" | "FFMPEG_BIN" | "FFPROBE_BIN" | "LOCAL_STORAGE_ROOT" | "LOCAL_RENDER_ROOT" | "LOCAL_THUMBNAIL_ROOT" | "LOCAL_BRAND_ROOT" | "CONTENT_LIBRARY_ENABLED" | "CONTENT_LIBRARY_PROVIDER" | "DRIVE_ROOT_FOLDER" | "DRIVE_REDIRECT_URI" | "YOUTUBE_REGION" | "YOUTUBE_RELEVANCE_LANGUAGE" | "YOUTUBE_REDIRECT_URI" | "PRIMARY_CHANNEL_KEY" | "AUTO_CHANNEL_DISCOVERY_ENABLED" | "AUTO_NEW_CHANNEL_MIN_SCORE" | "SERIES_VISUAL_CONTINUITY_ENABLED" | "SERIES_VISUAL_CONTINUITY_MAX_ASSETS" | "SERIES_VISUAL_MIN_OVERALL" | "SERIES_VISUAL_MIN_CHARACTER" | "SERIES_VISUAL_MIN_STYLE" | "MARKET_CYCLE_INTERVAL_HOURS" | "MARKET_JOB_PRIORITY" | "MARKET_MAX_QUERIES" | "MARKET_LOOKBACK_DAYS" | "MARKET_CYCLE_MAX_QUERIES" | "MARKET_CYCLE_RECENT_DAYS" | "MARKET_CYCLE_RESULTS_PER_QUERY" | "MARKET_PATTERN_LOOKBACK_DAYS" | "AUTO_PRODUCTION_MIN_SCORE" | "AUTO_PRODUCTION_MAX_PER_DAY" | "AUTO_PRODUCTION_DAILY_BUDGET_USD" | "AUTO_PRODUCTION_RESERVED_COST_USD" | "AUTO_SHORT_RESERVED_COST_USD" | "LEARNING_WINDOW_DAYS" | "ALLOW_COST_EXPERIMENTS" | "ANALYTICS_SYNC_DAYS" | "ANALYTICS_JOB_PRIORITY" | "SHORT_TO_LONG_MIN_VIEWS" | "SHORT_TO_LONG_MIN_AVP" | "LONG_TO_SHORT_MIN_VIEWS" | "LONG_TO_SHORT_MIN_AVP" | "JOB_MAX_ATTEMPTS" | "JOB_POLL_MS" | "JOB_STALE_MINUTES" | "JOB_TIMEOUT_MINUTES" | "JOB_RETRY_BASE_MS" | "JOB_RETRY_MAX_MS">> {}
}
