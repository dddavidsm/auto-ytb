...
## Current milestone: Intelligence Engine v0.4
...
- GitHub Actions CI
- adaptive competitor snapshot cadence
- lexical topic clustering baseline
- observed-evidence niche ranking + launch decision gate
